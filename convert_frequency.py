...
week, the program runs through all columns in reverse temporal order and adds the first non-NaN value to the output row that is in turn added 
to the output dataframe. For this function, it is important that the input data does not include any missing days.
